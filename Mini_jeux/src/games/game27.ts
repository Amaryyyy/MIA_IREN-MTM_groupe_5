...
export function startGame27(container, onFinish) {
  const levels = [
    {
      question: "1, 11, 21, 1211, ?",
      answer: "111221",
      hint: "Look-and-say : décris le terme précédent en chiffres."
    }
  ];
  ...
  // 👉 Police ballon dorée uniquement pour la séquence
